...
total_img = 95364  # 需要修改
validation_split_ratio = 0.15
max_train_img_size = int(train_task_id[-3:])
max_predict_img_size = int(train_task_id[-3:])  # 2400
assert max_train_img_size in [256, 384, 512, 640, 736, 1280], \
    'max_train_img_size must in [256, 384, 512, 640, 736,864,1280]'
if max_train_img_size == 256:
    ...
    batch_size = 24
steps_per_epoch = total_img * (1 - validation_split_ratio) // batch_size  # 每一个epoch迭代的次数
validation_steps = total_img * validation_split_ratio // batch_size  # 验证
